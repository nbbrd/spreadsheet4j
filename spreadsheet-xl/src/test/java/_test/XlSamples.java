 ...
 */
public final class XlSamples {

    private XlSamples() {
        throw new UnsupportedOperationException("This is a utility class and cannot be instantiated");
    }

    private static final byte[] XLSX_BYTES = Sample.bytesOf(XlSamples.class, "/Top5Browsers.xlsx");
    ...
    public static void assertTop5Book(Book book) throws IOException {
        BookAssert
                .assertThat(book)
                .hasSheetCount(3)
                .satisfies(XlSamples::assertTop5Sheet1, atIndex(0));
    }
